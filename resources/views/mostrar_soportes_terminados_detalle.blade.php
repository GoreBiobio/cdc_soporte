...
<div class="clearfix "></div>
  <div class="col-xs-12 col-lg-6">
  <div class="form-group">
    <label class="col-sm-3 col-xs-12 " style="color:#3c8dbc;">Informatica</label> 
    <label class="col-sm-9 col-xs-12">{{$personal_informatica[0]->nombresFunc}} {{$personal_informatica[0]->paternoFunc}}</label>
  </div>
</div>
<div class="col-xs-12 col-lg-6">
  <div class="form-group">
    <label class="col-sm-3 col-xs-12 " style="color:#3c8dbc;">Anexo</label> 
    <label class="col-sm-9 col-xs-12">{{$personal_informatica[0]->anexoFunc}}</label>
  </div>
</div>
<div class="clearfix "></div>
