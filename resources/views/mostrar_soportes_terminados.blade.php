              ...
              <div class="table-responsive">
                <table class="table no-marginx " id="tablapedidos">
                  ...
                  <tr>
                    ...
                    <td>    
                      <center><span type="button" class="btn btn-primary btn-xs" onclick="cargar_datos_modal('Soporte Terminado','idFunc|idSop','{{$datosSolicitudes->funcSolicSop}}|{{$datosSolicitudes->idSolSop}}','verDetalleSoporteTerminado');">
